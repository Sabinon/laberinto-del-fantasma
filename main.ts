namespace SpriteKind {
    export const FuegoDaño = SpriteKind.create()
    export const Gragon = SpriteKind.create()
    export const llave = SpriteKind.create()
    export const puerta = SpriteKind.create()
    export const Finall = SpriteKind.create()
}
...
function Terminar_juego () {
    for (let value of tiles.getTilesByType(sprites.builtin.forestTiles0)) {
        brillooooooo = sprites.create(img`
            . . . . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            . . . . . . . b d b . . . . . . 
            . . . . . . . b d b c . . . . . 
        ...
        tiles.placeOnTile(brillooooooo, value)
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.llave, function (sprite, otherSprite) {
...
function llave1 () {
    for (let value of tiles.getTilesByType(sprites.dungeon.collectibleBlueCrystal)) {
        ...
        tiles.placeOnTile(LLave1, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        LLave1.changeScale(0.5, ScaleAnchor.Middle)
    }
}
function Gragon2 () {
    for (let value of tiles.getTilesByType(sprites.dungeon.collectibleInsignia)) {
        Gragonmimido = sprites.create(img`
            . . . . . . . . . . . . . 7 . . 
            . . . . . . . . . . . . 7 7 7 . 
            . . . . . 7 . . . . 6 6 6 6 6 6 
            . . . . . . 7 7 6 6 6 6 9 9 9 6 
            . . . . . 7 6 6 6 9 9 9 9 9 9 9 
            . . . . . 6 6 9 9 9 9 9 9 9 9 9 
            . . . . 6 6 9 7 9 9 9 9 9 6 6 6 
            . . . 6 6 9 1 9 9 9 9 1 9 6 9 9 
            . . . 6 9 1 9 9 7 9 9 9 1 6 9 9 
            . . . 6 9 1 1 6 6 6 6 1 1 9 9 9 
            . . 6 9 6 1 1 1 9 9 6 1 6 9 9 9 
            . 6 9 9 9 1 1 9 9 9 9 6 6 9 9 9 
            6 9 9 9 9 9 9 9 f f 9 9 f 9 9 9 
            6 9 9 6 9 9 9 9 9 9 9 9 6 6 9 9 
            6 9 9 9 6 6 9 6 6 6 6 6 6 6 9 9 
            . 6 9 9 9 9 6 . 6 9 9 6 . . 6 6 
            `, SpriteKind.Gragon)
        animation.runImageAnimation(
        Gragonmimido,
        [img`
        ...
        tiles.placeOnTile(Gragonmimido, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
        Gragonmimido.changeScale(3, ScaleAnchor.Middle)
    }
}
function Abrepuerta () {
    for (let value of tiles.getTilesByType(sprites.dungeon.purpleOuterNorth0)) {
        ...
        tiles.placeOnTile(Puerta, value)
        tiles.setTileAt(value, assets.tile`transparency16`)
    }
}
function llamas () {
    for (let value of tiles.getTilesByType(sprites.dungeon.darkGroundCenter)) {
        Fuego = sprites.create(img`
            ...
            . . . . . 9 . . 9 9 9 . 9 . . . 
            . . . 8 9 9 9 6 9 8 . 9 . . . . 
            . . 9 . 9 8 9 6 9 8 9 9 6 9 9 . 
            . . 9 8 6 9 9 8 9 6 6 6 6 6 6 . 
            . 9 6 6 6 8 8 6 8 8 6 8 8 6 9 . 
            6 6 8 6 8 8 6 8 8 8 8 8 8 8 6 6 
            `, SpriteKind.FuegoDaño)
        animation.runImageAnimation(
        Fuego,
        [img`
            . . . . . . . . . . . . . . . . 
            ...
            . . . . . 9 8 . 9 6 8 . 9 . . . 
            . . . 8 9 9 9 6 9 9 . 8 . . . . 
            . . 9 . 9 6 9 6 9 8 9 9 6 9 9 . 
            . . 9 6 6 8 6 8 9 8 8 6 8 6 6 . 
            . 9 8 6 6 6 6 6 6 8 8 6 8 8 9 9 
            8 8 8 6 8 6 8 8 8 8 8 8 8 8 8 8 
            `,img`
            . . . . . . . 9 . . . . . . . . 
            . . . . . 9 . 9 . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            ...
            . . 9 . 9 9 8 . 9 9 9 . 9 . . . 
            . 9 . 8 9 6 8 8 8 8 . 9 . . . . 
            9 9 9 . 6 8 8 8 6 6 9 8 6 . . . 
            . 9 9 8 6 8 6 8 8 8 8 6 6 6 . . 
            9 9 6 6 8 8 8 6 8 9 8 8 8 6 9 . 
            6 6 8 6 8 8 8 8 8 8 8 8 6 8 8 . 
            `],
        500,
        true
        )
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Finall, function (sprite, otherSprite) {
    game.gameOver(true)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.FuegoDaño, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    music.play(music.melodyPlayable(music.zapped), music.PlaybackMode.UntilDone)
